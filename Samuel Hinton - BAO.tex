...
\specialrule{.1em}{.05em}{.05em} 
$0.44$ & $51.8$ & $0.119^{+0.029}_{-0.026}$ & $1.07^{+0.10}_{-0.10}$ & $-0.03^{+0.07}_{-0.10}$ & $54.0$ & $0.16\pm 0.05$ & $1.07\pm 0.14$ & $1.05\pm 0.16$ \\
$0.60$ & $69.3$ & $0.151^{+0.038}_{-0.025}$ & $0.98^{+0.08}_{-0.10}$ & $0.05^{+0.07}_{-0.10}$  & $39.2$ & $0.17\pm 0.05$ & $1.01\pm 0.12$ & $1.04\pm 0.15$ \\
$0.73$ & $59.1$ & $0.140^{+0.036}_{-0.022}$ & $1.00^{+0.08}_{-0.07}$ & $0.12^{+0.06}_{-0.05}$  & $41.4$ & $0.11\pm 0.04$ & $1.04\pm 0.11$ & $1.01\pm 0.12$ \\
\specialrule{.05em}{.05em}{.05em} 
All & $5.6$ & $0.140^{+0.014}_{-0.017}$ & $1.00^{+0.07}_{-0.05}$ & $0.06^{+0.03}_{-0.04}$ & $22.6$ & $0.147^{+0.012}_{-0.011}$ & $1.09^{+0.07}_{-0.06}$ & $1.00^{+0.07}_{-0.08}$ \\
\specialrule{.1em}{.05em}{.05em} 
...
\specialrule{.1em}{.05em}{.05em} 
$\Omega_c h^2$                &  $0.119^{+0.029}_{-0.026}$ &   $0.151^{+0.038}_{-0.025}$  &  $0.140^{+0.036}_{-0.022}$ & $0.155^{+0.023}_{-0.015}$ & $0.140^{+0.014}_{-0.017}$ & $0.16^{+0.05}_{-0.05}$ & $0.17^{+0.05}_{-0.05}$  & $0.11^{+0.04}_{-0.04}$ & $0.18^{+0.03}_{-0.04}$ & $ 0.147^{+0.012}_{-0.011}$\\
$D_A / D_A^{\mathcal{D}}$     &  $1.11 \pm  0.15$          &   $0.93 \pm  0.12$           &  $0.89 \pm  0.10$          & $0.89 \pm  0.06$          & $ 0.95 \pm  0.07$          & $1.07^{+0.14}_{-0.14}$ & $1.01^{+0.12}_{-0.12}$  & $1.04^{+0.11}_{-0.11}$ & $0.90^{+0.09}_{-0.04}$ & $1.09^{+0.07}_{-0.06}$ \\
$H / H^\mathcal{D}$           &  $1.00 \pm 0.18$           &   $0.94 \pm 0.15$           &  $0.80 \pm 0.10$          & $0.94 \pm 0.07$           & $0.89 \pm 0.08$          & $0.95\pm0.15$          & $0.96 \pm 0.15$ & $0.91 \pm 0.11$ & $1.08 \pm 0.09$ & $1.00 \pm 0.08$ \\
\specialrule{.1em}{.05em}{.05em} 
