...
\specialrule{.1em}{.05em}{.05em} 
$0.44$ & $52.5$ & $0.122^{+0.033}_{-0.024}$ & $1.05^{+0.08}_{-0.10}$ & $-0.03^{+0.06}_{-0.06}$ & $54.0$ & $0.16\pm 0.05$ & $1.07\pm 0.14$ & $1.05\pm 0.16$ \\
$0.60$ & $67.3$ & $0.160^{+0.035}_{-0.029}$ & $0.93^{+0.07}_{-0.06}$ & $0.05^{+0.05}_{-0.06}$  & $39.2$ & $0.17\pm 0.05$ & $1.01\pm 0.12$ & $1.04\pm 0.15$ \\
$0.73$ & $44.3$ & $0.159^{+0.033}_{-0.028}$ & $0.94^{+0.06}_{-0.06}$ & $0.11^{+0.05}_{-0.05}$  & $41.4$ & $0.11\pm 0.04$ & $1.04\pm 0.11$ & $1.01\pm 0.12$ \\
\specialrule{.05em}{.05em}{.05em} 
All & $6.8$ & $0.151^{+0.015}_{-0.016}$ & $0.97^{+0.06}_{-0.06}$ & $0.055^{+0.031}_{-0.038}$ & $22.6$ & $0.147^{+0.012}_{-0.011}$ & $1.09^{+0.07}_{-0.06}$ & $1.00^{+0.07}_{-0.08}$ \\
\specialrule{.1em}{.05em}{.05em} 
...
Using the multipole data analysis and fiducial cosmology, I present final constraints from the Wigglez analysis. These are shown in Table \ref{tab:wigglezBinsParams}.
...
\specialrule{.1em}{.05em}{.05em} 
$\Omega_c h^2$                &  $0.119^{+0.036}_{-0.021}$ &   $0.159^{+0.036}_{-0.027}$  &  $0.160^{+0.032}_{-0.029}$ & $0.155^{+0.023}_{-0.015}$ & $0.151^{+0.015}_{-0.016}$ & $0.16^{+0.05}_{-0.05}$ & $0.17^{+0.05}_{-0.05}$  & $0.11^{+0.04}_{-0.04}$ & $0.18^{+0.03}_{-0.04}$ & $ 0.147^{+0.012}_{-0.011}$\\
$D_A / D_A^{\mathcal{D}}$     &  $1.08 \pm  0.15$          &   $0.88 \pm  0.09$           &  $0.86 \pm  0.09$          & $0.89 \pm  0.06$          & $0.92 \pm  0.07$          & $1.07^{+0.14}_{-0.14}$ & $1.01^{+0.12}_{-0.12}$  & $1.04^{+0.11}_{-0.11}$ & $0.90^{+0.09}_{-0.04}$ & $1.09^{+0.07}_{-0.06}$ \\
$H / H^\mathcal{D}$           &  $1.00 \pm 0.13$           &   $0.97 \pm  0.11$           &  $0.86 \pm  0.09$          & $0.94 \pm 0.07$           & $0.93 \pm  0.08$          & $0.95\pm0.15$          & $0.96 \pm 0.15$ & $0.91 \pm 0.11$ & $1.08 \pm 0.09$ & $1.00 \pm 0.08$ \\
\specialrule{.1em}{.05em}{.05em} 
